...
{/* Confetti canvas */}
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-5 text-sm md:text-base"
        >
        ...
        >
          🥃 Sampling Hours: <span className="text-yellow-400 font-semibold">4:00 PM – 8:00 PM</span>
        </motion.p>
        ...
        >
          <a
            href="https://www.tequilafestusa.com/events/cincinnati#tickets"
